...
- LanceDB index cache eviction — currently LRU at 256MB, untested at scale.`,
    ...
    history: [
      { action: "created", by: "you", at: "2026-04-12T10:00:00Z" },
      {
        action: "edited",
        by: "you",
        at: "2026-04-22T14:15:00Z",
        reason: "added strategies section",
      },
      {
        action: "linked",
        by: "agent:spider",
        at: "2026-04-22T14:18:00Z",
        reason: "auto-linked Webhooks",
      },
...
Paths bake in folder structure. The graph should be navigable independent of where files live. See [[Vault structure]].`,
    ...
    history: [{ action: "created", by: "you", at: "2026-04-10T11:00:00Z" }],
...
Tried time-bands — failed. Notes don't cluster temporally enough to make horizontal stripes informative.`,
    ...
    history: [{ action: "created", by: "you", at: "2026-04-15T16:00:00Z" }],
...
- [[Standup]] — daily recap`,
    ...
    history: [{ action: "created", by: "you", at: "2026-04-08T09:00:00Z" }],
...
After 24h we shelf to DLQ and flag for manual replay.`,
    links: ["thr_t005"],
    history: [{ action: "created", by: "you", at: "2026-03-21T10:00:00Z" }],
...
We need extensions — wikilinks, frontmatter, callouts. CommonMark plus is the practical baseline.`,
    links: ["thr_t002"],
    history: [{ action: "created", by: "you", at: "2026-04-02T12:00:00Z" }],
...
By \`##\` header. Prepend title + tags before embedding so the chunk carries metadata context.`,
    links: ["thr_a005"],
    history: [{ action: "created", by: "you", at: "2026-04-05T14:00:00Z" }],
...
Blocked on input from [[Mira]].`,
  ...
  // Agents (as notes — referenced by other notes)
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:weaver", at: "2026-03-01T00:00:00Z" },
    ],
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:spider", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
    modified: yesterday,
    status: "active",
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:archivist", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:scribe", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:sentinel", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:researcher", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
  ...
  },
  {
    ...
    links: ["thr_t004"],
    history: [
      { action: "created", by: "agent:standup", at: "2026-03-01T00:00:00Z" },
    ],
    created: "2026-03-01T00:00:00Z",
...
Cache invalidation deep dive — see [[Caching]].`,
    ...
    history: [
      { action: "created", by: "agent:standup", at: "2026-05-16T07:00:00Z" },
    ],
...
- Plate React 19 compat — resolved with v49`,
    ...
    history: [
      { action: "created", by: "agent:standup", at: "2026-05-15T07:00:00Z" },
    ],
  ...
  },
  {
    ...
    links: [],
    history: [
      { action: "created", by: "agent:standup", at: "2026-05-14T07:00:00Z" },
    ],
  ...
  },
  {
    ...
    links: ["thr_a006"],
    history: [
      { action: "created", by: "agent:standup", at: "2026-05-13T07:00:00Z" },
    ],
  ...
  },
  {
    ...
    history: [
      { action: "created", by: "agent:standup", at: "2026-05-12T07:00:00Z" },
    ],
